...
add -lp datamem_addr_instr wr_addr_instr instr_addr1 instr_addr2 opcode_2bit single_bit1 single_bit0 zero LW SW  -v "instr[8:0]" "instr[26:22]"  "instr[21:17]" "instr[16:12]" "opcode[1:0]" "1'b1" "1'b0"  "0" "'d4" "'d5"  # LOCAL PARAM
###################### up_counter ########################
...
add -nw RAM_WIDTH RAM_ADDR_BITS PROG_FILE PROG_START_ADDR PROG_END_ADDR -ow RAM_WIDTH RAM_ADDR_BITS PROG_FILE PROG_START_ADDR PROG_END_ADDR -inst prg_mem_inst
...
add -nw RAM_WIDTH RAM_ADDR_BITS DATA_FILE INIT_START_ADDR  INIT_END_ADDR -ow RAM_WIDTH RAM_ADDR_BITS DATA_FILE DATA_START_ADDR DATA_END_ADDR -inst data_mem_inst
